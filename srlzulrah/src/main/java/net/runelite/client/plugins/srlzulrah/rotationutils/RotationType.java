...
public enum RotationType {
   ...
   private RotationType(String rotationName, List<ZulrahPhase> zulrahPhases) {
   ...
   public static List<RotationType> findPotentialRotations(NPC npc, int stage) {
      return (List)lookup.stream().filter((type) -> {
         return ((ZulrahPhase)type.getZulrahPhases().get(stage)).getZulrahNpc().equals(ZulrahNpc.valueOf(npc, false));
